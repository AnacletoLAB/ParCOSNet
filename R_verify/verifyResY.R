...
a <- read.table("/home/alessandro/dev/src/COSNet/build/outYeastCC.tsv",stringsAsFactors=F)
foldsFromFile <- read.table("/home/alessandro/dev/src/COSNet/build/foldsYeastCC.tsv",stringsAsFactors=F)
pred <- read.table("/home/alessandro/dev/src/COSNet/build/statesYeastCC.tsv",stringsAsFactors=F)
d <- readLines("/home/alessandro/dev/src/COSNet/build/geneYeastCC.tsv")
