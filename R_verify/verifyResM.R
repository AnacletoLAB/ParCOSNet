...
a <- read.table("outMouseCC.tsv",stringsAsFactors=F)
d <- readLines("geneMouseCC.tsv")
foldsFromFile <- read.table("foldsMouseCC.tsv",stringsAsFactors=F)
pred <- read.table("statesMouseCC.tsv",stringsAsFactors=F)
